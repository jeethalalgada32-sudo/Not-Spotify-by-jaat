...
// --- YOUTUBE PLAYER SETUP (Official Secure Link) ---
var tag = document.createElement('script');
// YE LINE DEKHO: Bilkul Sahi HTTPS Link hai
...
async function searchYT() {
    ...
    document.getElementById("searchInput").blur(); // Close keyboard
